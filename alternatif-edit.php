...
<body class="bg-[#f2f7ff]">
    ...
    <div class="p-4 sm:ml-80 mt-4">
        <h1 class="font-semibold text-2xl mb-5">Alternatif Edit</h1>
        <div class="p-6 bg-white border border-gray-200 rounded-lg shadow">
            <h1 class="font-semibold">Edit Data</h1>
            <form action="alternatif-update.php" method="POST" class="mt-5">
                <div class="mb-5">
                    <label for="text" class="block mb-2 text-sm font-medium text-gray-900">Alternatif</label>
