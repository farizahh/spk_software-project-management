...
<body class="bg-[#f2f7ff]">
    ...
    <div class="p-4 sm:ml-80 mt-4">
        <h1 class="font-semibold text-2xl mt-5">Data Alternatif</h1>
                        ...
                        <div class="relative p-4 w-full max-w-2xl max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <div class="p-4 md:p-5 space-y-4">
                                    <form action="alternatif-insert.php" method="post">
                                        <div>
                                            <label for="text" class="block mb-2 text-sm font-medium text-gray-900">Nama Kandidat</label>
                        ...
                        <tbody>
                            ...
                            if ($result) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<th class='px-3 py-4 w-20 text-center font-medium text-gray-900 whitespace-nowrap'>" . ++$i . "</th>";
                                    echo "<td class='px-3 py-4'>" . $row['nama'] . "</td>";
                                    echo "<td class='px-3 py-4 w-64 text-center'>
                                        <a href='alternatif-edit.php?edit=" . $row['id_alternatif'] . "' class='font-medium text-blue-600 hover:underline mr-3'>
                                            Edit
                                        </a> |
                                        <a href='alternatif-delete.php?delete=" . $row['id_alternatif'] . "' onclick='return confirmDelete()' type='button' class='font-medium text-blue-600 hover:underline ml-3'>
                                            Hapus 
                                        </a>
                                      </td>";
                                    echo "</tr>";
