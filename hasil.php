...
<body class="bg-[#f2f7ff]">
    ...
    <div class="p-4 sm:ml-80 mt-4">
        <h1 class="font-semibold text-2xl">Hasil Perhitungan SAW</h1>
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                        ...
                        <tbody>
                            ...
                            while ($row = $result->fetch_object()) {
                                $nilai_preferensi = ($row->C1 * 0.3800) + ($row->C2 * 0.1000) + ($row->C3 * 0.2500) + ($row->C4 * 0.1600) + ($row->C5 * 0.0400) + ($row->C6 * 0.0700);
